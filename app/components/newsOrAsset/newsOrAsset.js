class NewsOrAsset extends HTMLElement {
  ...
  constructor() {
    ...
    this.createStyles(
      "app/components/newsOrAsset/newsOrAsset-style-responsive.css"
    );
  ...
  addEventListeners() {
    this.shadow
      .querySelector("#acoes-btn")
      .addEventListener("click", () => this.handleAcoesClick());
    this.shadow
      .querySelector("#moedas-btn")
      .addEventListener("click", () => this.handleMoedasClick());
    this.shadow
      .querySelector("#criptomoedas-btn")
      .addEventListener("click", () => this.handleCriptoClick());
    this.shadow
      .querySelector("#resources-bnt")
      .addEventListener("click", () => this.handleResourcesClick());
    this.shadow
      .querySelector("#news-bnt")
      .addEventListener("click", () => this.handleNewsClick());
  }
  ...
  handleCriptoClick() {
    this.clearContainer();
    this.shadow.querySelector(".ContainerSwitchOption").innerHTML =
      "<cripto-component></cripto-component>";
    this.isOPtionsAssetOpen = true;
  ...
  handleResourcesClick() {
    if (this.isOPtionsAssetOpen) {
      this.shadow.querySelector(".containerChildrenElements").style.display =
        "none";
  ...
  managerBackGroundColors(state) {
    switch (state) {
      case "resources":
        this.shadow.querySelector("#resources-bnt").style.backgroundColor =
          "#444549";
        this.shadow.querySelector("#news-bnt").style.backgroundColor =
          "transparent";
        break;
      case "news":
        this.shadow.querySelector("#resources-bnt").style.backgroundColor =
  ...
  resetStateButtons() {
    this.shadow.querySelector("#criptomoedas-btn").style.backgroundColor =
      "transparent";
    this.shadow.querySelector("#moedas-btn").style.backgroundColor =
      "transparent";
    this.shadow.querySelector("#acoes-btn").style.backgroundColor =
      "transparent";
  }
}
